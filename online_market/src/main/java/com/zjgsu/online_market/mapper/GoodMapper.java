...
public interface GoodMapper extends BaseMapper<Good>{
    ...
    List<HashMap<String,Object>> getGoodDtoListByStatus(@Param("status") List<Integer> status, Integer current, Integer size);
    ...
    Integer countGoodDtoListByStatus(@Param("status") List<Integer> status);
    ...
    List<HashMap<String,Object>> getGoodDtoListBySearch(String val, Integer current, Integer size);
    @Select("<script>" +
            "select count(1)\n" +
            "from ( \n" +
            "    select good.gid,good.uid,good.gname,good.price,good.pri_cata,good.sec_cata,good.`status`,good.stock,good.description,img_url,\n" +
            ...
            "where group_idx = 1 and (gname like #{val} or description like #{val})\n"+
            "</script>")
    Integer countGoodDtoListBySearch(String val);
    ...
    List<HashMap<String,Object>> getGoodDtoListByCata(Integer pri,Integer sec, Integer current, Integer size);
    @Select("<script>" +
            "select count(1)\n" +
            "from ( \n" +
            "    select good.gid,good.uid,good.gname,good.price,good.pri_cata,good.sec_cata,good.`status`,good.stock,good.description,img_url,\n" +
    ...
    Integer countGoodDtoListByCata(Integer pri,Integer sec);
    ...
    List<HashMap<String,Object>> getAllGoodDtoList();
}
